...
$pdf->Cell(20, 1, "SHIFT/DAN RU      :   " . $shift, 0, 1, 'C');
...
$pdf->Cell(4,1,'NAMA','TB',0,'C'); //vertically merged cell
$pdf->Cell(2.2,1,'NIK','LBT',0,'C'); //vertically merged cell
$pdf->Cell(3.4,1,'JABATAN','1',0,'C'); //vertically merged cell
$pdf->Cell(2,1,'POS','1',0,'C'); //vertically merged cell
$pdf->Cell(4.4,1,'TANDA TANGAN','1',0,'C'); //vertically merged cell
$pdf->Cell(3,1,'KETERANGAN','BTR',1,'C'); //vertically merged cell
...
while ($row = $result->fetch_assoc()) {
  ...
  $pdf->Cell(4,0.8,'' . $row['nama'] . '','TB',0,'C'); //vertically merged cell
  $pdf->Cell(2.2,0.8,'' . $row['NIK'] . '','LBT',0,'C'); //vertically merged cell
  $pdf->Cell(3.4,0.8,'' . $row['jabatan'] . '','1',0,'C'); //vertically merged cell
  $pdf->Cell(2,0.8,'' . $row['pos'] . '','1',0,'C'); //vertically merged cell
  $pdf->Cell(4.4,0.8,'' . $row['ttd'] . '','1',0,'C'); //vertically merged cell
  $pdf->Cell(3,0.8,'' . $row['keterangan'] . '','BTR',1,'C'); //vertically merged cell  
}
