                            ...
                            <div class="card-body">
                                <form method="POST" action="aksi_security.php">
                                    ...
                                    <?php
                                        ...
                                        $queryCari = mysqli_query($koneksi,"SELECT * FROM tb_kendaraan LEFT JOIN tb_list_card ON tb_kendaraan.tbrk_no_card = tb_list_card.tblic_uid WHERE tbrk_uid LIKE '$uidReport'");
                                        while($infoKendaraan = mysqli_fetch_array($queryCari)){
                                    ?>

                                    <input type="hidden" class="form-control" name="input_plat_nomor" value="<?php echo $infoKendaraan['tbrk_uid']; ?>" readonly>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label" for="unit">Vehicle Type</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="info_jns_kendaraan" value="<?php echo $infoKendaraan['tbrk_jns_kendaraan']; ?>" readonly>
                                            </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label" for="unit">Tujuan</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="input_nomor_seal">
                                            </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label" for="unit">Nama Pengawal</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="input_nomor_sim">
                                            </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label" for="unit">No Surat Jalan</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="input_nomor_sim">
                                            </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label" for="unit">No Eseal</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="input_nomor_sim">
                                            </div>
                                    </div>
