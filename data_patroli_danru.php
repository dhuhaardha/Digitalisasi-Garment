                    ...
                    <!-- Container Data Karyawan -->
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h3 class="m-0 text-dark">Danru Patrol Report</h3>
                            </div>
                                                ...
                                                <tbody>
                                                        ...
                                                        <?php
                                                            ...
                                                            $queryPatroli = mysqli_query($koneksi,"SELECT * FROM tb_report_patroli
                                                                                                    ...
                                                                                                    WHERE tbrp_jns_report LIKE 'B004'");
                                ...
                                <div class="row mb-3">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Date</label>
                                        <div class="col-sm-10">
                                            ...
                                            <input type="hidden" name="informasi_kode" value="B004" class="form-control">
                                        </div>
                                </div>  
                                <div class="row mb-3">
