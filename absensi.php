...
<head>
    ...
    <title>Senior Staff Absence</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
                    ...
                    <!-- Container Data Karyawan -->
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h3 class="m-0 text-dark">Senior Staff Absence</h3>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col align-self-end">
                                        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modalTambah">
                                            <i class="fa-solid fa-user-clock">&nbsp</i>
                                                Check In
                                        </button>

                                        <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#modalNote">
                                ...
                                <p class="fs-3 fw-bold text-center">
                                    ...
                                    PRESENCE OF SENIOR STAFF</br>
                                    <h6 class="text-center">Day / Tanggal : <?php echo DATE('d-m-Y'); ?></h6>
                                </p>
                                        ...
                                        <form method="POST" action="aksi_security.php">
                                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                                ...
                                                <tbody>
                                                        ...
                                                        <?php
                                                            $urut = 1;
                                                            $absQuery = mysqli_query($koneksi,"SELECT * FROM tb_absensi WHERE tba_tanggal LIKE DATE_FORMAT(NOW(), '%Y-%m-%d')");
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    ?>
                                                                        ...
                                                                        <button type="submit" id="tombol_checkout_karyawan" name="tombol_checkout_karyawan" class="btn btn-danger" value="<?php echo $listAbsence['tba_nama']; ?>">
                                                                            <i class="fa-solid fa-person-circle-minus"> &nbsp; </i>Check Out
                                                                        </button>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Enter Senior Staff Information</h5>
                        ...
                        <form method="POST" action="aksi_security.php">
                                    ...
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Name</label>
                                        <div class="col-sm-10">
                                            <select id="inputState" class="form-select" name="input_nama">
                                                ...
                                                <?php
                                                    $nameQuery = mysqli_query($koneksi,"SELECT * FROM tb_karyawan");
                                                    while ($listName = mysqli_fetch_array($nameQuery)){
                                                ?>

                                                <option value="<?php echo $listName['tbk_nama']; ?>"><?php echo $listName['tbk_nama']; ?></option>
                            ...
                            <div class="modal-footer">
                                <button type="submit" name="tombol_checkin_karyawan" class="btn btn-success">Check In</button>
            ...
            <div class="modal fade" id="modalNote" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Adding Note</h5>
                            <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">×</span>
                            </button>
                        </div>
                        <form method="POST" action="aksi_security.php">
                            <div class="modal-body">
                                <div class="row mb-3">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Name</label>
                                        <div class="col-sm-10">
                                            <select id="inputState" class="form-select" name="input_nama_karyawan">
                                                <option selected>Choose Name...</option>

                                                <!-- data department dari database -->
                                                <?php
                                                    $nameQuery = mysqli_query($koneksi,"SELECT tba_nama FROM tb_absensi WHERE tba_detail IS NULL AND tba_tanggal LIKE DATE_FORMAT(NOW(), '%Y-%m-%d')");
                                                    while ($listName = mysqli_fetch_array($nameQuery)){
                                                ?>

                                                <option value="<?php echo $listName['tba_nama']; ?>"><?php echo $listName['tba_nama']; ?></option>
                                ...
                                <div class="row mb-3">
                                    <p id="paragraf_note"></p>
                                        <div class="row mb-3">
                                            <label for="inputEmail3" class="col-sm-2 col-form-label">Note</label>
                                                <div class="col-sm-10">
                                                    <textarea class="form-control" name="input_note_karyawan" rows="3"></textarea>
                                                </div>
                                        </div>
                                </div>
                            ...
                            <div class="modal-footer">
                                <button type="submit" name="tombol_note_karyawan" class="btn btn-success">Add Note</button>
                                <button class="btn btn-danger" type="button" data-dismiss="modal">Cancel</button>
                            </div>
                        </form>
                    </div>
            ...
            <div class="modal fade" id="modalPDF" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <form method="POST" action="cetak_absensi.php" target="_blank">
                            <div class="modal-body">
                                <div class="row mb-3">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Date</label>
                                        <div class="col-sm-10">
                                            <input type="date" name="input_print_pdf" class="form-control" id="usr">
                                        </div>
                                </div>                                
                            </div>
                            <div class="modal-footer">
                                <button type="submit" name="tombol_pdf_karyawan" target="_blank" class="btn btn-success">Export</button>
                                <button class="btn btn-danger" type="button" data-dismiss="modal">Cancel</button>
                            </div>
                        </form>
                    </div>
