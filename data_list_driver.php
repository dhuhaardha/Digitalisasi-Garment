                    ...
                    <!-- Container Data Karyawan -->
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h3 class="m-0 text-dark">Driver Information</h3>
                            </div>
                                        ...
                                        <form method="POST" action="aksi_security.php">
                                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                                ...
                                                <tbody>
                                                        ...
                                                        <?php
                                                            $noUrut = 1;
                                                            $cctvQuery = mysqli_query($koneksi,"SELECT * FROM tb_driver");
                                                            while($listCCTV = mysqli_fetch_array($cctvQuery)){
                                                        ?>

                                                            <tr>
                                                                <td><?php echo $noUrut++; ?></td>
                                                                <td><?php echo $listCCTV['unit']; ?></td>
                                                                <td><?php echo $listCCTV['nama']; ?></td>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Enter Driver Data</h5>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row mb-3">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Name</label>
                                        <div class="col-sm-10">
                                            <input type="text" style="text-transform: uppercase;" class="form-control" id="input_name" name="input_name">
                                        </div>
                                </div>
                            </div>
                            <div class="modal-footer">
                                <button type="submit" name="tombol_tambah_driver" class="btn btn-success">Add</button>
