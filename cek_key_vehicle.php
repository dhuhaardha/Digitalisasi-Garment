                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $data_item_array[3]; ?></td>
                                                        <td><?php echo $data_item_array[4]; ?></td>
                                                        <td><?php echo $data_item_array[5]; ?></td>
                                                        <td><?php echo $data_item_array[6]; ?></td>
                                                        <td><?php echo $data_item_array[7]; ?></td>
                                                        ...
                                                        if ($listKeyVehicle['status'] == 'DIAMBIL') {
                                                                ...
                                                                echo '<button type="button" class="btn btn-warning" data-toggle="modal" data-target="#modalGantiKunciDikembalikan" value="' . $listKeyVehicle['id_vehicle_key'] . '"><i class="fa-solid fa-handshake"></i></button>';
                                                        } else {
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                ...
                                <form method="POST" action="aksi_security.php">
                                    ...
                                    <div class="modal-footer">
                                        <button type="submit" name="tombol_tambah_operasional_key_vehicle" class="btn btn-success">Add</button>
